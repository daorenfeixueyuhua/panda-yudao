...
public class DemoWebSocketHandler extends TextWebSocketHandler implements InitializingBean {
    ...
    public void handleTextMessage(WebSocketSession session, TextMessage textMessage) throws Exception {
        ...
        try {
            // 获得消息类型
            final JSONObject jsonMessage = JSONUtil.parseObj(textMessage.getPayload());
            String messageType = jsonMessage.get("type", String.class);
            // 获得消息处理器
            ...
            // 处理消息
            Message messageObj = JSONUtil.toBean(jsonMessage.getJSONObject("body"), messageClass);
